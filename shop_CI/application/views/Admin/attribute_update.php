...
<span class="action-span1"><a href="index.php?act=main">SHOP 管理中心</a> </span><span id="search_id" class="action-span1"> - 属性修改 </span>
...
<div class="main-div">
  ...
  <table width="100%" id="general-table">
      <tbody><tr>
        ...
        <td>
          <input type="text" name="attr_name" size="30" value="<?=$attr['attr_name'];?>">
        ...
        <td>
          ...
          <option value="0">请选择...</option>
              <?php foreach($type as $val):?>
                  <?php if($attr['type_id']==$val['type_id']):?>
      ...
      <tr>
        ...
        <td>
            <?php if($attr['attr_index']==0):?>
          <input type="radio" name="attr_index" value="0" checked>
          不需要检索          <input type="radio" name="attr_index" value="1">
          关键字检索          <input type="radio" name="attr_index" value="2">
          范围检索
          <?php elseif($attr['attr_index']==1):?>
            <input type="radio" name="attr_index" value="0">
            不需要检索          <input type="radio" name="attr_index" value="1" checked>
            关键字检索          <input type="radio" name="attr_index" value="2">
            范围检索
            <?php else:?>
            <input type="radio" name="attr_index" value="0">
            不需要检索          <input type="radio" name="attr_index" value="1">
            关键字检索          <input type="radio" name="attr_index" value="2" checked>
            范围检索
            <?php endif;?>
            <br><span class="notice-span" style="display:block" id="noticeindex">不需要该属性成为检索商品条件的情况请选择不需要检索，需要该属性进行关键字检索商品时选择关键字检索，如果该属性检索时希望是指定某个范围时，选择范围检索。</span>
        </td>
      </tr>
      <tr>
        <td class="label">相同属性值的商品是否关联？</td>
        <td>
        <?php if($attr['attr_linked']==0):?>
          <input type="radio" name="attr_linked" value="0" checked> 否          <input type="radio" name="attr_linked" value="1"> 是
        <?php else:?>
            <input type="radio" name="attr_linked" value="0"> 否          <input type="radio" name="attr_linked" value="1" checked> 是
        <?php endif;?>
        </td>
      </tr>
      <tr>
        ...
        <td>
            <?php if($attr['attr_type']==0):?>
          <input type="radio" name="attr_type" value="0" checked> 唯一属性          <input type="radio" name="attr_type" value="1"> 单选属性          <input type="radio" name="attr_type" value="2"> 复选属性          <br><span class="notice-span" style="display:block" id="noticeAttrType">选择"单选/复选属性"时，可以对商品该属性设置多个值，同时还能对不同属性值指定不同的价格加价，用户购买商品时需要选定具体的属性值。选择"唯一属性"时，商品的该属性值只能设置一个值，用户只能查看该值。</span>
            <?php elseif($attr['attr_type']==1):?>
            <input type="radio" name="attr_type" value="0"> 唯一属性          <input type="radio" name="attr_type" value="1" checked> 单选属性          <input type="radio" name="attr_type" value="2"> 复选属性          <br><span class="notice-span" style="display:block" id="noticeAttrType">选择"单选/复选属性"时，可以对商品该属性设置多个值，同时还能对不同属性值指定不同的价格加价，用户购买商品时需要选定具体的属性值。选择"唯一属性"时，商品的该属性值只能设置一个值，用户只能查看该值。</span>
            <?php else:?>
                <input type="radio" name="attr_type" value="0"> 唯一属性          <input type="radio" name="attr_type" value="1"> 单选属性          <input type="radio" name="attr_type" value="2" checked> 复选属性          <br><span class="notice-span" style="display:block" id="noticeAttrType">选择"单选/复选属性"时，可以对商品该属性设置多个值，同时还能对不同属性值指定不同的价格加价，用户购买商品时需要选定具体的属性值。选择"唯一属性"时，商品的该属性值只能设置一个值，用户只能查看该值。</span>
            <?php endif;?>
        </td>
      </tr>
      <tr>
        ...
        <td>
          ...
          <input type="radio" name="attr_input_type" value="0" checked>
        ...
        <?php elseif($attr['attr_input_type']==1):?>
            ...
            手工录入          <input type="radio" name="attr_input_type" value="1" checked>
            从下面的列表中选择（一行代表一个可选值）          <input type="radio" name="attr_input_type" value="2" >
            多行文本框
            <?php else:?>
                <input type="radio" name="attr_input_type" value="0">
                手工录入          <input type="radio" name="attr_input_type" value="1">
                从下面的列表中选择（一行代表一个可选值）          <input type="radio" name="attr_input_type" value="2"  checked>
                多行文本框
            <?php endif;?>
        </td>
      </tr>
      <tr>
          ...
          <td>
              <input type="text" name="attr_order" value="<?=$attr['attr_order']?>">
          </td>
      </tr>
      <tr>
