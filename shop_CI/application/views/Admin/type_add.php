...
<span class="action-span1"><a href="{:U('Index/main')}?act=main">SHOP 管理中心</a> </span><span id="search_id" class="action-span1"> - 新建商品类型 </span>
  ...
  <form action="" method="post" name="theForm" onsubmit="return validate();">
    <table cellspacing="1" cellpadding="3" width="100%">
      <tbody><tr>
        ...
        <td><input type="text" name="type_name" size="40"></td>
      </tr>
      <tr>
        <td class="label">状态:</td>
        <td><input type="radio" name="type_status" value="0">&nbsp;禁用&nbsp;<input type="radio" name="type_status" value="1">&nbsp;启用&nbsp;</td>
      </tr>
      <tr>
        ...
        <td>
          <textarea name="type_group" rows="5" cols="40"></textarea><br>
