...
<span class="action-span1"><a href="{:U('Index/main')}?act=main">SHOP 管理中心</a> </span><span id="search_id" class="action-span1"> - 供货商修改 </span>
...
<table cellspacing="1" cellpadding="3" width="100%">
  <tbody><tr>
    ...
    <td><input type="text" name="supplier_name" maxlength="60" placeholder="数字字母下划线或汉字" value="<?=$data['supplier_name']?>"></td>
  </tr>
  <tr>
    <td class="label">供货商描述</td>
    <td><textarea name="supplier_desc" cols="60" rows="4" id="content"><?=$data['supplier_desc']?></textarea>
  ...
  <tr>
    ...
    <td>
      <?php if($data['supplier_show']==0):?>
      <input type="radio" name="supplier_show" value="1"> 是
      <input type="radio" name="supplier_show" value="0" checked="checked"> 否
      <?php else:?>
      <input type="radio" name="supplier_show" value="1" checked="checked"> 是
