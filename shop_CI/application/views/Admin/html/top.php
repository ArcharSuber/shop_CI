...
<div id="header-div">
	<div id="logo-div" style="bgcolor:#000000;">
		<img src="<?php echo base_url('public/Admin/images/')?>ecshop_logo.gif" alt="ECSHOP - power for e-commerce" />
	</div>
	...
	<div id="submenu-div">
		<ul>
			  ...
			  <li><a href="<?=site_url('Home/Index/show')?>" target="_blank">查看网店</a></li>
