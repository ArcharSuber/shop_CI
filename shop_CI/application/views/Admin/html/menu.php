...
<head>
	...
	<script type="text/javascript" src="<?php echo base_url('public/Admin/js/')?>transport.js"></script>
	<style type="text/css">
		...
		.explode {background: url(<?php echo base_url('public/Admin/images/')?>menu_minus.gif) no-repeat 0px 3px; font-weight: bold;}
		.collapse { background: url(<?php echo base_url('public/Admin/images/')?>menu_plus.gif) no-repeat 0px 3px; font-weight: bold;}
		.menu-item { background: url(<?php echo base_url('public/Admin/images/')?>menu_arrow.gif) no-repeat 0px 3px; font-weight: normal;}
	...
	<div id="tabbar-div">
		<p>
			<span style="float:right; padding: 3px 5px;">
				<a href="javascript:toggleCollapse();"><img id="toggleImg" src="<?php echo base_url('public/Admin/images/')?>menu_minus.gif" width="9" height="9" border="0" alt="闭合"></a>
			</span>
		...
		<div id="menu-list">
			<ul id="menu-ul">
				<li class="explode" key="02_cat_and_goods" name="menu"> 商品管理        
					<ul>
						  <li class="menu-item"><a href="<?php echo site_url('Admin/Goods/lists')?>" target="main-frame">商品列表</a></li>
						  <li class="menu-item"><a href="<?php echo site_url('Admin/Cate/lists')?>?act=list" target="main-frame">商品分类</a></li>
						  <li class="menu-item"><a href="<?php echo site_url('Admin/Attribute/lists')?>?act=list" target="main-frame">商品属性</a></li>
						  <li class="menu-item"><a href="<?php echo site_url('Admin/Brand/lists')?>?act=list" target="main-frame">商品品牌</a></li>
						  <li class="menu-item"><a href="<?php echo site_url('Admin/Type/lists')?>?act=list" target="main-frame">商品类型</a></li>
						  <li class="menu-item"><a href="<?php echo site_url('Admin/Garbage/lists')?>" target="main-frame">商品回收站</a></li>
				...
				<li class="explode" key="04_order" name="menu"> 订单管理        
					<ul style="display: block;">
						<li class="menu-item"><a href="<?=site_url('Admin/Order/lists')?>?act=list" target="main-frame">订单列表</a></li>
				...
				<li class="collapse" key="10_priv_admin" name="menu"> 权限管理        
					<ul style="display: none;">
						<li class="menu-item"><a href="<?php echo site_url('Admin/Node/lists')?>?act=list" target="main-frame">权限列表</a></li>
						<li class="menu-item"><a href="<?php echo site_url('Admin/Role/lists')?>?act=list" target="main-frame">角色列表</a></li>
						<li class="menu-item"><a href="<?php echo site_url('Admin/Admin/lists')?>?act=list" target="main-frame">管理员列表</a></li>
						...
						<li class="menu-item"><a href="<?php echo site_url('Admin/Supplier/lists');?>?act=list" target="main-frame">供货商列表</a></li>
					</ul>
				</li>
...
function toggleCollapse()
{
  ...
  collapse = !collapse;
  document.getElementById('toggleImg').src = collapse ? '<?php echo base_url('public/Admin/images/')?>menu_minus.gif' : '<?php echo base_url('public/Admin/images/')?>menu_plus.gif';
