...
<h1>
<span class="action-span1"><a href="{:U('Index/main')}?act=main">SHOP 管理中心</a> </span><span id="search_id" class="action-span1"> - 商品转移供货商 </span>
<div style="clear:both"></div>
</h1>
<!-- start add new category form -->
<div class="main-div">
	<form method="post">
		<input type="hidden" value="<?=$str?>" name="supplier_str">
		<table>
			<tr>
				<td class="label">请选择转移的供货商:</td>
				<td>
